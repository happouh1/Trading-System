CREATE TABLE IF NOT EXISTS operations_prospective_review_bundle_chain_exports (
 export_id TEXT PRIMARY KEY,
 materialization_id TEXT NOT NULL REFERENCES operations_prospective_review_bundle_materializations(materialization_id),
...
CREATE TABLE IF NOT EXISTS operations_prospective_review_bundle_chain_export_verifications (
