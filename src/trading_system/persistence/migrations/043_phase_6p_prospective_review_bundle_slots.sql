CREATE TABLE IF NOT EXISTS operations_prospective_review_bundle_plans (
...
CREATE TABLE IF NOT EXISTS operations_prospective_review_bundle_slots (
 plan_id TEXT NOT NULL REFERENCES operations_prospective_review_bundle_plans(plan_id),
 slot_id TEXT NOT NULL, expected_as_of TEXT NOT NULL, payload_json TEXT NOT NULL,
 payload_hash TEXT NOT NULL, PRIMARY KEY(plan_id,slot_id)
);
CREATE TABLE IF NOT EXISTS operations_prospective_review_bundle_bindings (
 binding_id TEXT PRIMARY KEY, plan_id TEXT NOT NULL REFERENCES operations_prospective_review_bundle_plans(plan_id),
